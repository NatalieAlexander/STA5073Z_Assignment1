...
# 3. Tokenization
```{tokenization, eval=T, fig.show=T, fig.cap= "Bar plots showing the 20 most frequently used (a) words and (b) bigrams used by all presidents"}
